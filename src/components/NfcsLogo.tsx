...
export const NfcsLogo: React.FC<NfcsLogoProps> = ({
  ...
  if (!imgError) {
    return (
      <img
        ...
        alt="Official NFCS UNN Logo"
        width={size}
        height={size}
        style={{ width: `${size}px`, height: `${size}px` }}
        className={`shrink-0 object-contain drop-shadow-xs transition-transform ${className}`}
  ...
  return (
    ...
    >
      <defs>
        <path id="topArc" d="M 60,250 A 190,190 0 1,1 440,250" fill="none" />
